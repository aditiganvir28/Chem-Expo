...
GLdouble SO3_coords[4][3] = {
    {0, 0, 0},        // Center (Sulfur) position
    {-1.0, -0.5, 0.0}, // Oxygen (O1) position
    {0.0, 1.0, 0.0},   // Oxygen (O3) position
    {1.0, -0.5, 0.0}  // Oxygen (O2) position
};
...
GLfloat sulfur[3] = {0.5, 0.5, 0.5};      // Carbon (C) color - Grey
GLfloat oxygen[3] = {1, 0.5, 0.0};  
...
void draw_SO3(GLfloat center[3])
{
    ...
    {
        glPushMatrix();
        glTranslatef(SO3_coords[i][0] + center[0],
                     SO3_coords[i][1] + center[1],
                     SO3_coords[i][2] + center[2]);
        if (i == 0)
            atome(sulfur); // Define sulfur color
        else
            atome(oxygen); // Define oxygen color
        glPopMatrix();
    }
    ...
    renderCylinder( SO3_coords[1][0] + center[0], SO3_coords[1][1] + center[1], SO3_coords[1][2] + center[2],
                    SO3_coords[0][0] + center[0], SO3_coords[0][1] + center[1], SO3_coords[0][2] + center[2],
                   cylinderRadius, myQuad);

    glColor3fv(white);
    setLightColor(white);
    renderCylinder(SO3_coords[2][0] + center[0], SO3_coords[2][1] + center[1], SO3_coords[2][2] + center[2],
                   SO3_coords[0][0] + center[0], SO3_coords[0][1] + center[1], SO3_coords[0][2] + center[2],
                   cylinderRadius, myQuad);
    
    glColor3fv(white);
    setLightColor(white);
    renderCylinder(SO3_coords[0][0] + center[0], SO3_coords[0][1] + center[1], SO3_coords[0][2] + center[2],
                   SO3_coords[3][0] + center[0], SO3_coords[3][1] + center[1], SO3_coords[3][2] + center[2],
                   cylinderRadius, myQuad);
}
